...
public interface FiltersApi {
   ...
   */
  @GET("api/v1/profiles/{profileId}/categories/{categoryId}/filters")
   ...
   * @return Call&lt;List&lt;QualityFilter&gt;&gt;
   */
  @GET("api/v1/profiles/{profileId}/categories/{categoryId}/filters/{id}")
  Call<List<QualityFilter>> filtersId(
    @retrofit2.http.Path("profileId") String profileId, @retrofit2.http.Path("categoryId") String categoryId, @retrofit2.http.Path("id") Integer id, @retrofit2.http.Query("max") Integer max
  );
